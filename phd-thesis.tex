...
\begin{document}
	...
	\chapter{Background}
	\input{chapters/pt1_background.tex}
	
	\chapter{Introduction}
	\input{chapters/pt1_introduction.tex}
	
	\chapter{State of the art}
	\input{chapters/pt1_state_of_the_art.tex}
	
	\chapter{Simplified problem formulation}
	\input{chapters/pt1_chapter5.tex}
	
	\chapter{Considering fixture rotations and extrusion areas}
	\input{chapters/pt1_chapter6.tex}
	
	\chapter{FlatZinc based Particle Swarm Optimization}
	\input{chapters/pt1_chapter7.tex}
	
	\chapter{Conclusion}
	\input{chapters/pt1_conclusion.tex}
	
	\part{Heating Process Optimization}
	
	\chapter{Background}
	\input{chapters/pt2_background.tex}
	
	\chapter{Introduction}
	\input{chapters/pt2_introduction.tex}
	
	\chapter{State of the art}
	\input{chapters/pt2_state_of_the_art.tex}
	
	\chapter{Surrogate model}
	\input{chapters/pt2_chapter12.tex}
	
	\chapter{Inverse model}
	\input{chapters/pt2_chapter13.tex}
	
	\chapter{Optimization}
	\input{chapters/pt2_chapter14.tex}
	
	\chapter{Conclusion}
	\input{chapters/pt2_conclusion.tex}
	
	\chapter{Overall conclusion}
	\input{chapters/overall_conclusion.tex}
